    ...
    <div class="col-12 col-lg-12">
        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form method="post" action="<?= route_to('store_user'); ?>" enctype='multipart/form-data' class="form form-vertical">
                        <?= csrf_field(); ?>
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group position-relative">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ?>" placeholder="Nama" id="Nama" name="nama" value="<?= old('nama'); ?>">
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-12" id="hide">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group position-relative">
                                                ...
                                                <input type="number" class="form-control <?= ($validation->hasError('nip')) ? 'is-invalid' : '' ?>" placeholder="NIP" id="nip" name="nip" value="<?= old('nip'); ?>">
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group position-relative">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->hasError('unit')) ? 'is-invalid' : '' ?>" id="unit" name="unit" value="<?= old('unit'); ?>">
                                                <div class="invalid-feedback">
